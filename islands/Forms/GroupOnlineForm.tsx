...
export default function GroupOnlineForm() {
    ...
    <div class="max-w-2xl mx-auto w-full bg-white dark:bg-gray-800 p-8  border-solid border-2 border-brand-black-900 shadow-custom-black-400">
      {submitStatus === "success" ? (
        ...
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6" role="alert">
          ...
          <p>Prøv venligst igen senere, eller kontakt os direkte på hej@creativeoak.dk.</p>
        </div>
      ) : null}
      
      <form onSubmit={handleSubmit} class="space-y-6">
        <div>
          <label htmlFor="navn" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Navn
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="beskrivelse" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Beskrivelse
          </label>
          <textarea
            id="beskrivelse"
            name="beskrivelse"
            placeholder={"Beskriv hvordan du er blevet snydt af group online"}
        ...
        <div class="flex items-start">
          ...
          <div class="ml-2 text-sm">
            <label htmlFor="nyhedsbrev" class="font-medium  text-gray-700 dark:text-gray-300">
              Ja tak, jeg vil gerne modtage nyhedsbrev
            </label>
            <p class="text-gray-500 dark:text-gray-400">Du kan til enhver tid afmelde dig igen.</p>
          </div>
        </div>
      ...
      <div class="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <p class="mt-1">
          <a href="tel:+4553534290" class="text-brand-blue hover:underline">+45 53 53 42 90</a> eller{" "}
          <a href="mailto:hej@creativeoak.dk" class="text-brand-blue hover:underline">hej@creativeoak.dk</a>
        </p>
      </div>
    </div>
  );
