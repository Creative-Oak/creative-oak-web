...
const ServiceCardSection = () => {
  return (
    <section class=" bg-brand-blue">
      <div class="container mx-auto px-4 py-24 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        <ServiceCard tags={["SEO", "Bæredygtigt design", "Visuel identitet"]} href="#" title="Hjemmeside udvikling" />
